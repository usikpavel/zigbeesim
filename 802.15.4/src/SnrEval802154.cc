 ...
 * description: - mains tasks are to determine the SNR for a message and
 ...
 *
 **/
void SnrEval802154::handleLowerMsgEnd(AirFrame *frame)
{
...
void SnrEval802154::receiveBBItem(int category, const BBItem *details, int scopeModuleId)
{
 ...
 *
 **/
void SnrEval802154::modifySnrList(SnrList& list)
{
 ...
 **/
double SnrEval802154::calcPathloss(AirFrame* frame)
{
    simtime_t time;
    double sqrdistance;
    double pRecv;
...
const double SnrEval802154::speedOfLight = 300000000.0;
